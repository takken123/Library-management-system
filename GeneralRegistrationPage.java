...
public class GeneralRegistrationPage extends JFrame implements ActionListener
{
    ...
    public GeneralRegistrationPage(String title)
    {
     super(title);
    ...
    {
	    GeneralRegistrationPage obj=new GeneralRegistrationPage("Login Page");
	    obj.setVisible(true);
	}
